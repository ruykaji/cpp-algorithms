...
// int specialization
template <> int Tbllf<int>::s_default_value = 11;
...
template <> std::string Tbllf<std::string>::s_default_value = "k";
...
TYPED_TEST(Typed_doubly_linked_list_fixture, Copy_constructor_on_empty_list)
{
...
TYPED_TEST(Typed_doubly_linked_list_fixture, Move_constructor_on_empty_list)
{
  typename TestFixture::List list_a__{};
  typename TestFixture::List list_b__(std::move(list_a__));
...
TYPED_TEST(Typed_doubly_linked_list_fixture, Initializer_list_assignment_less_size)
{
  typename TestFixture::List list__(TestFixture::s_list_a);

  list__.erase(list__.begin());
  list__ = TestFixture::s_list_b;

  TestFixture::compare_containers(list__, TestFixture::s_list_b);
}

TYPED_TEST(Typed_doubly_linked_list_fixture, Initializer_list_assignment_bigger_size)
{
  typename TestFixture::List list__(TestFixture::s_list_a);

  list__.insert(list__.begin(), TestFixture::s_default_value);
  list__ = TestFixture::s_list_b;

  TestFixture::compare_containers(list__, TestFixture::s_list_b);
}

TYPED_TEST(Typed_doubly_linked_list_fixture, Copy_assignment)
{
  typename TestFixture::List list_a__(TestFixture::s_list_a);
...
TYPED_TEST(Typed_doubly_linked_list_fixture, Copy_assignment_of_empty_list)
{
  typename TestFixture::List list_a__(TestFixture::s_list_a);
...
TYPED_TEST(Typed_doubly_linked_list_fixture, Move_assignment)
{
  typename TestFixture::List list_a__(TestFixture::s_list_a);
  typename TestFixture::List list_b__(TestFixture::s_list_b);
...
TYPED_TEST(Typed_doubly_linked_list_fixture, Move_assignment_of_empty_list)
{
  typename TestFixture::List list_a__(TestFixture::s_list_a);
  typename TestFixture::List list_b__{};
...
TYPED_TEST(Typed_doubly_linked_list_fixture, Insert_a_lvalue)
{
  typename TestFixture::List list__(TestFixture::s_list_a);
...
TYPED_TEST(Typed_doubly_linked_list_fixture, Insert_an_amount_of_values)
{
  typename TestFixture::List list__;

  list__.insert(list__.begin(), 10, TestFixture::s_default_value);
...
TYPED_TEST(Typed_doubly_linked_list_fixture, Insert_a_container)
{
  typename TestFixture::List list__;
  std::vector<typename TestFixture::List::value_type> vec__(TestFixture::s_list_a);

  list__.insert(list__.begin(), vec__.begin(), vec__.end());

  TestFixture::compare_containers(list__, vec__);
}

TYPED_TEST(Typed_doubly_linked_list_fixture, Erase_a_value)
{
  typename TestFixture::List list__(TestFixture::s_list_a);
  std::vector<typename TestFixture::List::value_type> vec__(TestFixture::s_list_a);
...
TYPED_TEST(Typed_doubly_linked_list_fixture, Erase_a_range_of_values)
{
  typename TestFixture::List list__(TestFixture::s_list_a);
  std::vector<typename TestFixture::List::value_type> vec__(TestFixture::s_list_a);
  ...
  list__.erase(list__.begin(), list_list__);

  TestFixture::compare_containers(list__, vec__);
}

TYPED_TEST(Typed_doubly_linked_list_fixture, Splice_lvalue_list)
{
  typename TestFixture::List list_a__;
  typename TestFixture::List list_b__(TestFixture::s_list_b);

  list_a__.splice(list_a__.begin(), list_b__);
...
TYPED_TEST(Typed_doubly_linked_list_fixture, Splice_rvalue_list)
{
  typename TestFixture::List list_a__;

  list_a__.splice(list_a__.begin(), typename TestFixture::List(TestFixture::s_list_b));

  TestFixture::compare_containers(list_a__, TestFixture::s_list_b);
}

TYPED_TEST(Typed_doubly_linked_list_fixture, Splice_within_a_range)
{
  typename TestFixture::List list_a__;
  typename TestFixture::List list_b__(TestFixture::s_list_b);

  list_a__.splice(list_a__.begin(), list_b__.begin(), list_b__.end());
